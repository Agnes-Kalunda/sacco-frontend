...
const Socials = () => {
  ...
  return (
    <div className="socials" style={{ backgroundColor: '#212529', color: 'white', display: 'flex', alignItems: 'center', width:"100%" , height:"50px"}}>
      <h6>
        <small><i className="fas fa-envelope mr-3"></i> unitysacco@gmail.com</small>
      </h6>
      <h6>
